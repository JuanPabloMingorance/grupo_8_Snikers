...
CREATE TABLE `products` (
  ...
  KEY `fk_product_brands_idx` (`marca_id`),
  KEY `fk_product_sections_idx` (`seccion_id`),
  CONSTRAINT `fk_product_brands` FOREIGN KEY (`marca_id`) REFERENCES `brands` (`id`),
  CONSTRAINT `fk_product_category` FOREIGN KEY (`categoria_id`) REFERENCES `categories` (`id`),
  CONSTRAINT `fk_product_sections` FOREIGN KEY (`seccion_id`) REFERENCES `sections` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-10-28 23:02:52
